import { Signal, SignalCallback } from "@rbxts/lemon-signal/dist/LemonSignal";
...
interface IconEvents {
	...
	deselected: Signal<void>;
	toggled: Signal<[isSelected: boolean]>;
	viewingStarted: Signal<void>;
	viewingEnded: Signal<void>;
	notified: Signal<void>;
}
...
interface Icon extends IconEvents {
	 ...
	 * @chainable
	 */
	notify(clearNoticeEvent: RBXScriptSignal | Signal<unknown>): this;
	/** @chainable */
	clearNotices(): this;
	/**
	 ...
	 * @chainable
	 */
	bindEvent<T extends IconEventName>(name: T, callback: InferEventCallback<T> | SignalCallback<T>): this;
	/**
